console.log('This is the background page. 1.018');
...
chrome.runtime.onMessage.addListener( (message, sender, sendResponse) => {
    ...
    fetch("http://ec2-16-170-232-234.eu-north-1.compute.amazonaws.com/?product="+product+"&latitude="+latitude+"&longitude="+longitude, {
        method: "GET",
        mode: "cors",
